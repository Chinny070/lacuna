...
export const forms = {
  ...
  outcomeEvidence: { key: "submitOutcomeEvidence", title: "Add outcome evidence", description: "Record what actually happened during the observation window.", submit: "Submit outcome evidence", fields: [
    { label: "Evidence ID", name: "evidence_id", type: "text" }, { label: "Agreement ID", name: "agreement_id", type: "text" }, { label: "Source type", name: "source_type", type: "text" }, { label: "Validated source URL", name: "source_url", type: "text" }, { label: "Submitter content hash", name: "content_hash", type: "text", hint: "A 64-character lowercase SHA-256 identifier. Freeze replaces it with a verified snapshot digest." }, { label: "Summary", name: "summary", type: "textarea" }, { label: "Metric reference", name: "metric_ref", type: "text" }, { label: "Observed value", name: "observed_value_bps", type: "number", hint: "Basis points; 6,100 = 61%." }, { label: "Period start", name: "period_start", type: "number" }, { label: "Period end", name: "period_end", type: "number" },
  ] },
